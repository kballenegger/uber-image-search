...
// ATValidations
#define COCOAPODS_POD_AVAILABLE_ATValidations
#define COCOAPODS_VERSION_MAJOR_ATValidations 0
#define COCOAPODS_VERSION_MINOR_ATValidations 1
#define COCOAPODS_VERSION_PATCH_ATValidations 1
